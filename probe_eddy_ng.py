...
class ProbeEddy:
    def __init__(self, config: ConfigWrapper):
        ...
        sensors = {
            ...
            "ldc1612_usb": ldc1612_ng.LDC1612_ng,
    ...
    def cmd_SETUP_next(self, gcmd: GCodeCommand, kin_pos: Optional[List[float]]):
        ...
        max_dc_increase = 0
        if self._sensor_type == "ldc1612" or self._sensor_type == "btt_eddy" or self._sensor_type == "ldc1612_internal_clk" or self._sensor_type == 'ldc1612_usb':
            max_dc_increase = 5
